        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              <a href="category.php?id=<?php echo $row['id']?>">Delete</a>
            </td>
          </tr>
        </tbody>
      <?php endwhile; ?>
  ...
  <div class="row">
   ...
   <div class="col-md-8">
      ...
      <form action="add_category.php" method="post">
        ...
        <input type="submit" value="Add" style="background-color: #1ab394; border-radius: 5px; padding: 5px 5px;color: white;">
      </form>
   </div>
    <div class="col-md-2"></div>
  </div>
