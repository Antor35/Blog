...
<div id=content>
  <header>
   <h2 class="page_title">Blog user information</h2>
  </header>
  <?php if($users): ?>
    ...
    <table class="table">
        ...
        <tbody>
          <tr>
            ...
            <td><img src="<?php echo $row['image']; ?>" style="height: 75px; width: 75px;"></td>
            <td><?php echo $row['name']; ?></td>
            <td><?php echo $row['email']; ?></td>
            <td><?php echo $row['username']; ?></td>
            <td><a href="user.php?id=<?php echo $row['id']?>">Delete</a></td>
          </tr>
        </tbody>
      <?php endwhile; ?>
      </table>
